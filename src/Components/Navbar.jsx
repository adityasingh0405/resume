...
export default function Navbar({ setPage }) {
  return (
    <nav className="absolute top-8 left-1/2 transform -translate-x-1/2 bg-[#111111] border-green-400 rounded-lg shadow-lg z-50 px-8 py-4 flex gap-4 items-center border-2 backdrop-blur-md">
      <button
